...
[![Maturity](https://github.com/giellalt/lang-fro/raw/generated/docs-data/fst-maturity.svg)](https://giellalt.github.io/MaturityClassification.html)
![Lemma count](https://github.com/giellalt/lang-fro/raw/generated/docs-data/fst-lemmacount.svg)
[![Speller suggestion quality](https://github.com/giellalt/lang-fro/raw/generated/docs-data/speller-suggestions.svg)](https://giellalt.github.io/lang-fro/typosreport/)
...
[![Windows](https://img.shields.io/badge/download%40latest-Windows--bhfst-brightgreen)](https://pahkat.uit.no/main/download/speller-fro?platform=windows&channel=nightly)
[![MacOS](https://img.shields.io/badge/download%40latest-macOS--bhfst-brightgreen)](https://pahkat.uit.no/main/download/speller-fro?platform=macos&channel=nightly)
[![Mobile](https://img.shields.io/badge/download%40latest-mobile--bhfst-brightgreen)](https://pahkat.uit.no/main/download/speller-fro?platform=mobile&channel=nightly)
...
[LICENSE](https://github.com/giellalt/lang-fro/blob/main/LICENSE). The
authors named in the AUTHORS file are available to grant other licencing
choices.

Install proofing tools and [keyboards](https://github.com/giellalt/keyboard-fro)
for the Old French language by using the [Divvun Installer](http://divvun.no)
...
- [Language specific documentation](https://giellalt.github.io/lang-fro/)
- [General documentation](https://giellalt.github.io/)

Core dependencies
-----------------

In order to compile and use Old French language morphology and
...
Using Git:
```
git clone https://github.com/giellalt/lang-fro
```

Using Subversion:
```
svn checkout https://github.com/giellalt/lang-fro.git/trunk lang-fro
```

Building and installation
-------------------------

[INSTALL](https://github.com/giellalt/lang-fro/blob/main/INSTALL)
